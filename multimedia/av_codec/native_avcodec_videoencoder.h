...
/**
 * @brief Set the asynchronous callback function so that your application can respond to the events generated by the
 * video encoder. This interface is optional only for input surface. If this interface is used, it must be invoked before
 * {@link OH_VideoEncoder_Prepare} and after {@link OH_VideoEncoder_GetSurface}.
 * @param codec Pointer to an OH_AVCodec instance
