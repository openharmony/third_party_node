...
{
    CHECK_EQ(1, managedObjects.erase(id));
}
...
public:
    ...
    void StartSession(int sessionId, const std::string& targetId) override;
...
void InspectorIoDelegate::StartSession(int sessionId, const std::string& targetId)
{
...
// namespace per_process = jsvm::per_process;
...
bool Agent::Start(const std::string& path, int pid)
{
    ...
    return Start(path, hostPort, true, false);
}
